    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" id="archivo_form"> 
                ...
                <input type="hidden" id="id_dde2" name="id_dde">
                ...
                <div class="container">
                    ...
                    <div class="col-lg-12">
                        <fieldset class="form-group">
                            <label class="form-label semibold" for="d_cod2">Se subirá un archivo para la Dirección Distrital:</label>
                            <input type="text" class="form-control" id="d_cod2" name="d_cod2" disabled>
                        </fieldset>
                    </div>
