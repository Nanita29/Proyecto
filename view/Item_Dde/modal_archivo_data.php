    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <input type="hidden" id="id_dde3" name="id_dde">
                ...
                <div class="container">
                    ...
                    <div class="col-lg-12">
                        <fieldset class="form-group">
                            <label class="form-label semibold" for="d_cod3">Archivos compartidos para la Dirección Distrital:</label>
                            <input type="text" class="form-control" id="d_cod3" name="d_cod3" disabled>
                        </fieldset>
                    </div>
