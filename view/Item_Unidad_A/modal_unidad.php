                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" id="e1_2t" name="e1_2" value="2" /> Aprobado <br>
                                        <input type="radio" id="e1_2f" name="e1_2" value="1" /> Reprobado
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" id="e2_2t" name="e2_2" value="2" /> Aprobado<br>
                                        <input type="radio" id="e2_2f" name="e2_2" value="1" /> Reprobado
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" id="e3_2t" name="e3_2" value="2" /> Aprobado<br>
                                        <input type="radio" id="e3_2f" name="e3_2" value="1" /> Reprobado
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" id="e4_2t" name="e4_2" value="2" /> Aprobado<br>
                                        <input type="radio" id="e4_2f" name="e4_2" value="1" /> Reprobado
                                    </td>
                                </tr>
                            </thead>
                        </table>
