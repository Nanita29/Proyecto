	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<p>
					Desde esta ventana podrá registrar una nueva Unidad Educativa "A"
				</p>
							...
							<div><h5 class="m-t-lg with-border">ESTADOS DE MONITOREO</h5></div>
								...
								<div class="col-lg-6">
									<fieldset class="form-group">
										...
										<input style="display: none" type="text" class="form-control" id="file1" name="file1" placeholder="Ingrese el código">
										<button type="button" onclick="fileUno()">Cargar Archivo</button>
									</fieldset>
								</div> 
								...
								<div class="col-lg-6">
									<fieldset class="form-group">
										...
										<input style="display: none" type="text" class="form-control" id="file2" name="file2" placeholder="Ingrese el código">
										<button type="button" onclick="fileDos()">Cargar Archivo</button>
									</fieldset>
								</div> 
								...
								<div class="col-lg-6">
									<fieldset class="form-group">
										...
										<input style="display: none" type="text" class="form-control" id="file4" name="file4" placeholder="Ingrese el código">
										<button type="button" onclick="fileCuatro()">Cargar Archivo</button>
									</fieldset>
								</div> 
