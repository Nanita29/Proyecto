...
?>
	...
	<title>Educo : Consultar CAP "Adolescentes"</title>
		...
		<div class="container-fluid">
			...
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Consultar CAP "Adolescentes"</h3>
							<ol class="breadcrumb breadcrumb-simple">
							<li><a href="../Home/index.php">Inicio</a></li>
								<li class="active">Consultar CAP "Adolescentes"</li>
							</ol>
						</div>
					</div>
				</div>
