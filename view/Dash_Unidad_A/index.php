...
<body class="with-side-menu">
	...
	<div class="page-content">
		...
		<h3 class="m-t-lg with-border">Unidades Educativas R2.IVO6,R2.IVO7</h3>
		...
		<!-- <div class="container-fluid">
			<h5 class="m-t-lg with-border">Estados de Monitoreo (X)</h5>
			<div class="col-xl-12">
				<div class="row">
						<div class="col-sm-6">
							<section class="card">
		...
		<div class="container-fluid">
			<h5 class="m-t-lg with-border">Estados de Monitoreo (Y)</h5>
			<div class="col-xl-12">
				<div class="row">
						<div class="col-sm-6">
							<section class="card">
	...
	<script type="text/javascript" src="dash_ua.js"></script>
