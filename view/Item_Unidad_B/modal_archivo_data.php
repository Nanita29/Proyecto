    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <input type="hidden" id="id_unidad_a3" name="id_unidad_a">
                ...
                <div class="container">
                    ...
                    <div class="col-lg-12">
                        <fieldset class="form-group">
                            <label class="form-label semibold" for="a_cod3">Archivos compartidos para la Unidad Educativa:</label>
                            <input type="text" class="form-control" id="a_cod3" name="a_cod3" disabled>
                        </fieldset>
                    </div>
