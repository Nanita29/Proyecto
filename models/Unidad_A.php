<?php
    ...
    class Unidad_A extends Conectar{
        ...
        $a_director_tel,$a_dna,$a_centro_salud,$a_tecnico,$a_docen_ini_v,$a_docen_ini_m,$a_docen_pri_v,$a_docen_pri_m,
        ...
        $a_per_med_m,$a_per_enf_v,$a_per_enf_m,$e1,$e2,$e3,$e4,$e1_2,$e2_2,$e3_2,$e4_2){
            ...
            a_cod, a_nombre, a_director_nombre, a_director_tel, a_dna, a_tecnico, a_centro_salud, a_docen_ini_v, a_docen_ini_m, a_docen_pri_v,/*  13 */
        ...
        public function update_unidad($id_unidad_a,$id_usuario,$id_comunidad,$id_fuente, $a_cod ,$a_nombre,$a_director_nombre,
        $a_director_tel,$a_dna,$a_centro_salud,$a_tecnico,$a_docen_ini_v,$a_docen_ini_m,$a_docen_pri_v,$a_docen_pri_m,
        $a_docen_sec_v,$a_docen_sec_m,$a_est_ini_v,$a_est_ini_m,$a_est_pri_v,$a_est_pri_m,$a_est_sec_v,$a_est_sec_m,$a_per_med_v,
        $a_per_med_m,$a_per_enf_v,$a_per_enf_m,$e1,$e2,$e3,$e4,$e1_2,$e2_2,$e3_2,$e4_2){
            $conectar= parent::conexion();
            ...
            $sql="UPDATE unidad_educativa_a  SET 
             ...
             a_director_nombre='".$a_director_nombre."',a_director_tel='".$a_director_tel."', a_dna='".$a_dna."', a_centro_salud='".$a_centro_salud."',
             a_tecnico='".$a_tecnico."', a_docen_ini_v='".$a_docen_ini_v."', a_docen_ini_m='".$a_docen_ini_m."', a_docen_pri_v='".$a_docen_pri_v."',
             ...
             e1_2='".$e1_2."',e2_2='".$e2_2."',e3_2='".$e3_2."',e4_2='".$e4_2."',a_fecha_mod=now(),us_mod='".$id_usuario."'
        ...
        public function listar_unidad(){
            ...
            municipio.nombre_mun, comunidad.nombre_com, unidad_educativa_a.a_avance,unidad_educativa_a.a_avance2, e1,e2,e3,e4,e1_2,e2_2,e3_2,e4_2
            FROM 
        ...
        public function listar_unidad_r2($id_usuario){
            ...
            AND comunidad.id_municipio = municipio.id_municipio
            AND unidad_educativa_a.id_estado = 2
            AND municipio.id_departamento = departamento.id_departamento
        ...
        public function get_un_dep_a($id_usuario){
            $conectar= parent::conexion();
            parent::set_names();
            ...
            d.nombre_dep
            ORDER BY nom DESC";
            /* $sql="SELECT CONCAT(d.nombre_dep, ', ', d.descripcion_dep) as nom,COUNT(*) AS total
            FROM   unidad_educativa_a a, comunidad b, municipio c, departamento d 
            where a.id_comunidad = b.id_comunidad
            and b.id_municipio = c.id_municipio
            and c.id_departamento = d.id_departamento
        ...
        public function get_un_fue_a($id_usuario){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        public function get_un_mun_a($id_usuario){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        public function get_av_un_dep_a($id_usuario){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT CONCAT(d.nombre_dep) as nom,AVG(a.a_avance) AS totalx,AVG(a.a_avance2) AS totaly
            FROM   unidad_educativa_a a, comunidad b, municipio c, departamento d 
            where a.id_comunidad = b.id_comunidad
            and b.id_municipio = c.id_municipio
        ...
        //Total estado 1 y
        public function get_estado1_2($id_usuario){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        //Total estado 2 y
        public function get_estado2_2($id_usuario){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        //Total estado 3 y
        public function get_estado3_2($id_usuario){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        //Total estado 4 y
        public function get_estado4_2($id_usuario){
            $conectar= parent::conexion();
            parent::set_names();
